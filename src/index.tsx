        ...
        <Router style={{ width: "100%", height: "100%" }}>
          ...
          <PartyScreen
            ...
            setPlayerName={(playerName: string) => {
              window.peer.send(
                JSON.stringify(joinParty(window.peerId, playerName))
              );
            }}
...
> {
  render() {
    return (
      <div className="app">
        <h1
          style={{ fontSize: 80, fontFamily, color: "#e91e63", paddingTop: 90 }}
        >
          Gojuki
        </h1>
    ...
    return (
      ...
      >
        ...
        <div className="upgradesMenu__header" style={{ color: "white" }}>
          <h3>
            Food:{" "}
            <span style={{ color: "#e91e63", marginRight: 50 }}>{food}</span>
          </h3>
          <h3>
            Time to next round:{" "}
            <span style={{ color: "#e91e63" }}>{timeToNextRound}</span>{" "}
            seconds...
          </h3>
        </div>
        <div
